# Available .GALLERY One-Word Domains (8,746)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C745%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C746%20domains-6f42c1">
...
> **Important:** this repository is a **public 8,745-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **8,746 domains** on the canonical page below.

**Public extract:** 8,745 rows · **Live catalog:** 8,746 domains
...
- `gallery.csv` — public CSV extract (8,745 rows)
- `gallery.json` — public JSON extract (8,745 rows)
...
| ----------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------------------------------------------------------- |
| mail.gallery      | available | $36.98    | —             | 76             | 60     | 4      | namecheap                                                 |
| palestine.gallery | resell    | —         | —             | 59             | 93     | 9      | GoDaddy.com, LLC                                          |
| athletics.gallery | premium   | $42.90    | $42.90        | 69             | 52     | 9      | namecheap                                                 |
| true.gallery      | available | $36.98    | —             | 86             | 52     | 4      | namecheap                                                 |
| domain.gallery    | resell    | —         | —             | 80             | 64     | 6      | Porkbun LLC                                               |
| all.gallery       | premium   | $500      | $500          | 88             | 48     | 3      | name.com                                                  |
| only.gallery      | available | $36.98    | —             | 110            | 47     | 4      | namecheap                                                 |
| home.gallery      | resell    | —         | —             | 100            | 62     | 4      | Global Domains International, Inc. DBA DomainCostClub.com |
| big.gallery       | premium   | $41.99    | $41.25        | 88             | 46     | 3      | name.com                                                  |
| genius.gallery    | available | $36.98    | —             | 98             | 46     | 6      | namecheap                                                 |
| open.gallery      | resell    | —         | —             | 106            | 61     | 4      | Dynadot Inc                                               |
| law.gallery       | premium   | $85.80    | $85.80        | 82             | 46     | 3      | namecheap                                                 |
| strategy.gallery  | available | $36.98    | —             | 74             | 43     | 8      | namecheap                                                 |
| web.gallery       | resell    | —         | —             | 72             | 61     | 3      | Sav.com, LLC                                              |
| hotel.gallery     | premium   | $85.80    | $85.80        | 70             | 46     | 5      | namecheap                                                 |
| agile.gallery     | available | $36.98    | —             | 92             | 42     | 5      | namecheap                                                 |
| code.gallery      | resell    | —         | —             | 72             | 61     | 4      | NameCheap, Inc.                                           |
| health.gallery    | premium   | $128.70   | $128.70       | 92             | 45     | 6      | namecheap                                                 |
...
| ----------------------- | ------------------------------------------------ |
| 8,745-row public sample | 8,746 live domains                               |
...
> Unique Domains. *Available .GALLERY One-Word Domains*. Version 2026-04-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
